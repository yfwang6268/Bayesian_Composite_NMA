...
|     Get $k = p/\text{Trace}\left[H\left(\tau_{k, t-1}, \mu_k\right)^{-1}J(\tau_{k, t-1}, \mu_k)\right]$ where $p$ is the number of columns of $\left[H\left(\tau_{k, t-1}, \mu_k\right)^{-1}J(\tau_{k, t-1}, \mu_k)\right]$
...
To adjust the likelihood on sampling $\mu$, we inherent the derivation and adjust the likelhood part
$$
\begin{aligned}
...
|     Get $k = p/\text{Trace}\left[H\left(\tau_{k, t-1}, \mu_{k, t-1}\right)^{-1}J\left(\tau_{k, t-1}, \mu_{k, t-1}\right)\right]$ where $p$ is the number of columns of $\left[H\left(\tau_{k, t-1}, \mu_{k, t-1}\right)^{-1}J\left(\tau_{k, t-1}, \mu_{k, t-1}\right)\right]$
